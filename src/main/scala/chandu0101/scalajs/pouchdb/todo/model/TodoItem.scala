package chandu0101.scalajs.pouchdb.todo.model
...
object TodoItem {
  ...
  def fromJson(obj : js.Dynamic) : TodoItem = TodoItem(obj._id.toString,obj._rev.toString,obj.title.toString,obj.completed.asInstanceOf[Boolean])
